...
class EditEvent extends StatefulWidget {
  ...
  @override
  State<EditEvent> createState() => _CreateEventScreenState();
}

class _CreateEventScreenState extends State<EditEvent> {
  late TaskModel task;
  ...
  void didChangeDependencies() {
    if (!isInit) {
      ...
      var date = DateTime.fromMicrosecondsSinceEpoch(task.date);
      formatted = DateFormat('dd/MM/yyyy').format(date);
      selectedCategoryIndex = categories.indexOf(task.category);
      isInit = true;
    }
  }
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        ...
                        FirebaseManager.updateEvent(taskModel);
